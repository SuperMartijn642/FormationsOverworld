        ...
        generator.lootTable("cobble_hole")
            ...
            .pool(pool ->
                pool.uniformRolls(1, 2)
                    ...
                    .enchantedItemEntry(Items.CHAINMAIL_HELMET, 5, false, 1)
                    .enchantedItemEntry(Items.CHAINMAIL_CHESTPLATE, 5, false, 1)
                    .enchantedItemEntry(Items.CHAINMAIL_LEGGINGS, 5, false, 1)
                    .enchantedItemEntry(Items.CHAINMAIL_BOOTS, 5, false, 1)
                    .enchantedItemEntry(Items.IRON_SWORD, 5, false, 1)
                    .enchantedItemEntry(Items.IRON_PICKAXE, 5, false, 1)
            )
            .pool(pool ->
