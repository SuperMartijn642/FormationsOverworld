        ...
        generator.lootTable("stone_tower/bedroom")
            ...
            .pool(pool ->
                pool.uniformRolls(5, 8)
                    ...
                    .itemEntry(Items.AMETHYST_SHARD, 1, 5, 1)
                    ...
                    .itemEntry(Items.TURTLE_SCUTE, 1, 3, 1)
        ...
        generator.lootTable("stone_tower/smithing")
            ...
            .pool(pool ->
                pool.uniformRolls(0, 2)
                    .enchantedItemEntry(Items.CHAINMAIL_HELMET, 10, 12)
                    .enchantedItemEntry(Items.CHAINMAIL_CHESTPLATE, 10, 12)
                    .enchantedItemEntry(Items.CHAINMAIL_LEGGINGS, 10, 12)
                    .enchantedItemEntry(Items.CHAINMAIL_BOOTS, 10, 12)
                    .enchantedItemEntry(Items.IRON_HELMET, 10, 5)
                    .enchantedItemEntry(Items.IRON_CHESTPLATE, 10, 5)
                    .enchantedItemEntry(Items.IRON_LEGGINGS, 10, 5)
                    .enchantedItemEntry(Items.IRON_BOOTS, 10, 5)
                    .enchantedItemEntry(Items.IRON_SWORD, 10, 5)
                    .enchantedItemEntry(Items.IRON_PICKAXE, 10, 5)
                    .enchantedItemEntry(Items.IRON_AXE, 10, 5)
        ...
        generator.lootTable("stone_tower/basement")
            ...
            .pool(pool ->
                pool.uniformRolls(1, 5)
                    ...
                    .itemEntry(Items.DIAMOND, 1, 2, 2)
                    .itemEntry(Items.NAME_TAG)
                    .enchantedItemEntry(Items.BOOK, 20, 1)
