        ...
        generator.lootTable("tower_remnant")
            ...
            .pool(pool ->
                pool.uniformRolls(0, 1)
                    .enchantedItemEntry(Items.SHIELD, 10, true, 5)
                    .enchantedItemEntry(Items.BOW, 10, true, 5)
                    .enchantedItemEntry(Items.IRON_SWORD, 10, true, 1)
                    .itemEntry(Items.IRON_SWORD, 5)
                    .enchantedItemEntry(Items.IRON_PICKAXE, 10, true, 1)
