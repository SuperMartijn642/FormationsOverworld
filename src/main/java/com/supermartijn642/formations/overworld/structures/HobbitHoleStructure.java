        ...
        generator.lootTable("hobbit_hole/common")
            ...
            .pool(pool ->
                pool.uniformRolls(1, 3)
                    .itemEntry(Items.STONE_SWORD, 3)
                    .itemEntry(Items.STONE_PICKAXE, 3)
                    .itemEntry(Items.STONE_AXE, 3)
                    .itemEntry(Items.STONE_SHOVEL, 3)
                    .itemEntry(Items.LEATHER_HELMET, 3)
                    .itemEntry(Items.LEATHER_CHESTPLATE, 3)
                    .itemEntry(Items.LEATHER_LEGGINGS, 3)
                    .itemEntry(Items.LEATHER_BOOTS, 3)
                    ...
                    .enchantedItemEntry(Items.BOOK, 20, false, 1)
            );
