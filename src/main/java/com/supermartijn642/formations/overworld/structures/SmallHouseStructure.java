    ...
    protected void createLootTables(FormationsLootTableGenerator generator){
        generator.lootTable("small_house/intact")
            ...
            .pool(pool ->
                pool.uniformRolls(1, 2)
                    ...
                    .enchantedItemEntry(Items.WOODEN_SWORD, 20, 1)
                    .enchantedItemEntry(Items.IRON_SHOVEL, 20, 1)
                    .enchantedItemEntry(Items.IRON_AXE, 20, 1)
                    .enchantedItemEntry(Items.CHAINMAIL_HELMET, 20, 1)
                    .enchantedItemEntry(Items.CHAINMAIL_CHESTPLATE, 20, 1)
                    .enchantedItemEntry(Items.CHAINMAIL_LEGGINGS, 20, 1)
                    .enchantedItemEntry(Items.CHAINMAIL_BOOTS, 20, 1)
            );
        generator.lootTable("small_house/degraded")
            ...
            .pool(pool ->
                pool.uniformRolls(0, 1)
                    .enchantedItemEntry(Items.BOOK, 20, 5)
                    .enchantedItemEntry(Items.WOODEN_SWORD, 20, 2)
                    .enchantedItemEntry(Items.IRON_SWORD, 20, 2)
                    .enchantedItemEntry(Items.IRON_SHOVEL, 20, 2)
                    .enchantedItemEntry(Items.IRON_AXE, 20, 2)
                    .enchantedItemEntry(Items.IRON_PICKAXE, 20, 2)
                    .enchantedItemEntry(Items.CHAINMAIL_HELMET, 20, 1)
                    .enchantedItemEntry(Items.CHAINMAIL_CHESTPLATE, 20, 1)
                    .enchantedItemEntry(Items.CHAINMAIL_LEGGINGS, 20, 1)
                    .enchantedItemEntry(Items.CHAINMAIL_BOOTS, 20, 1)
                    .enchantedItemEntry(Items.IRON_HELMET, 20, 1)
                    .enchantedItemEntry(Items.IRON_CHESTPLATE, 20, 1)
                    .enchantedItemEntry(Items.IRON_LEGGINGS, 20, 1)
                    .enchantedItemEntry(Items.IRON_BOOTS, 20, 1)
            );
