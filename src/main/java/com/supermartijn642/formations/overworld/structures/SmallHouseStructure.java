        ...
        generator.lootTable("small_house/intact")
            ...
            .pool(pool ->
                pool.uniformRolls(2, 3)
                    ...
                    .itemEntry(Items.COOKED_SALMON, 2, 5, 20)
                    .itemEntry(Items.GOLDEN_CARROT, 3, 5, 1)
                    .itemEntry(Items.COOKIE, 3, 5, 15)
            ...
            .pool(pool ->
                pool.uniformRolls(1, 2)
                    ...
                    .enchantedItemEntry(Items.WOODEN_SWORD, 15, true, 1)
                    .enchantedItemEntry(Items.IRON_SHOVEL, 15, true, 1)
                    .enchantedItemEntry(Items.IRON_AXE, 15, true, 1)
                    .enchantedItemEntry(Items.CHAINMAIL_HELMET, 15, true, 1)
                    .enchantedItemEntry(Items.CHAINMAIL_CHESTPLATE, 15, true, 1)
                    .enchantedItemEntry(Items.CHAINMAIL_LEGGINGS, 15, true, 1)
                    .enchantedItemEntry(Items.CHAINMAIL_BOOTS, 15, true, 1)
            );
        generator.lootTable("small_house/degraded")
            .chestParameters()
            .pool(pool ->
                pool.uniformRolls(4, 5)
                    .itemEntry(Items.COBWEB, 6, 12, 10)
                    .itemEntry(Items.BOOK, 2, 5, 15)
                    .itemEntry(Items.GOLDEN_CARROT, 3, 8, 1)
            )
            .pool(pool ->
                pool.uniformRolls(0, 1)
                    .enchantedItemEntry(Items.BOOK, 15, true, 5)
                    .enchantedItemEntry(Items.WOODEN_SWORD, 15, true, 2)
                    .enchantedItemEntry(Items.IRON_SWORD, 15, true, 2)
                    .enchantedItemEntry(Items.IRON_SHOVEL, 15, true, 2)
                    .enchantedItemEntry(Items.IRON_AXE, 15, true, 2)
                    .enchantedItemEntry(Items.IRON_PICKAXE, 15, true, 2)
                    .enchantedItemEntry(Items.CHAINMAIL_HELMET, 15, true, 1)
                    .enchantedItemEntry(Items.CHAINMAIL_CHESTPLATE, 15, true, 1)
                    .enchantedItemEntry(Items.CHAINMAIL_LEGGINGS, 15, true, 1)
                    .enchantedItemEntry(Items.CHAINMAIL_BOOTS, 15, true, 1)
                    .enchantedItemEntry(Items.IRON_HELMET, 15, true, 1)
                    .enchantedItemEntry(Items.IRON_CHESTPLATE, 15, true, 1)
                    .enchantedItemEntry(Items.IRON_LEGGINGS, 15, true, 1)
                    .enchantedItemEntry(Items.IRON_BOOTS, 15, true, 1)
            );
