...
public class SmallHouseStructure extends StructureConfigurator {
    ...
    protected void createLootTables(FormationsLootTableGenerator generator){
        generator.lootTable("small_house/intact")
            ...
            .pool(pool ->
                pool.uniformRolls(1, 2)
                    ...
                    .enchantedItemEntry(Items.WOODEN_SWORD, 15, 1)
                    .enchantedItemEntry(Items.IRON_SHOVEL, 15, 1)
                    .enchantedItemEntry(Items.IRON_AXE, 15, 1)
                    .enchantedItemEntry(Items.CHAINMAIL_HELMET, 15, 1)
                    .enchantedItemEntry(Items.CHAINMAIL_CHESTPLATE, 15, 1)
                    .enchantedItemEntry(Items.CHAINMAIL_LEGGINGS, 15, 1)
                    .enchantedItemEntry(Items.CHAINMAIL_BOOTS, 15, 1)
            );
        generator.lootTable("small_house/degraded")
            ...
            .pool(pool ->
                pool.uniformRolls(0, 1)
                    .enchantedItemEntry(Items.BOOK, 15, 5)
                    .enchantedItemEntry(Items.WOODEN_SWORD, 15, 2)
                    .enchantedItemEntry(Items.IRON_SWORD, 15, 2)
                    .enchantedItemEntry(Items.IRON_SHOVEL, 15, 2)
                    .enchantedItemEntry(Items.IRON_AXE, 15, 2)
                    .enchantedItemEntry(Items.IRON_PICKAXE, 15, 2)
                    .enchantedItemEntry(Items.CHAINMAIL_HELMET, 15, 1)
                    .enchantedItemEntry(Items.CHAINMAIL_CHESTPLATE, 15, 1)
                    .enchantedItemEntry(Items.CHAINMAIL_LEGGINGS, 15, 1)
                    .enchantedItemEntry(Items.CHAINMAIL_BOOTS, 15, 1)
                    .enchantedItemEntry(Items.IRON_HELMET, 15, 1)
                    .enchantedItemEntry(Items.IRON_CHESTPLATE, 15, 1)
                    .enchantedItemEntry(Items.IRON_LEGGINGS, 15, 1)
                    .enchantedItemEntry(Items.IRON_BOOTS, 15, 1)
            );
