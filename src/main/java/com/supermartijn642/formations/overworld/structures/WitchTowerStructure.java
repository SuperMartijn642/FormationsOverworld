...
public class WitchTowerStructure extends StructureConfigurator {
    ...
    protected void createLootTables(FormationsLootTableGenerator generator){
        ...
        generator.lootTable("witch_tower/smithing")
            ...
            .pool(pool ->
                pool.uniformRolls(0, 1)
                    .enchantedItemEntry(Items.IRON_SWORD, 10, 3)
                    .enchantedItemEntry(Items.IRON_PICKAXE, 10, 3)
                    .enchantedItemEntry(Items.IRON_AXE, 10, 3)
                    .enchantedItemEntry(Items.IRON_SHOVEL, 10, 3)
                    .enchantedItemEntry(Items.IRON_HOE, 10, 2)
                    .enchantedItemEntry(Items.CHAINMAIL_HELMET, 10, 4)
                    .enchantedItemEntry(Items.CHAINMAIL_CHESTPLATE, 10, 4)
                    .enchantedItemEntry(Items.CHAINMAIL_LEGGINGS, 10, 4)
                    .enchantedItemEntry(Items.CHAINMAIL_BOOTS, 10, 4)
            );
        ...
        generator.lootTable("witch_tower/contraption_reward")
            ...
            .pool(pool ->
                pool.uniformRolls(1, 2)
                    .enchantedItemEntry(Items.IRON_SWORD, 15, 20, 10)
                    .enchantedItemEntry(Items.IRON_PICKAXE, 15, 20, 10)
                    .enchantedItemEntry(Items.IRON_AXE, 15, 20, 10)
                    .enchantedItemEntry(Items.IRON_SHOVEL, 15, 20, 10)
                    .enchantedItemEntry(Items.IRON_HOE, 15, 20, 10)
                    .enchantedItemEntry(Items.IRON_HELMET, 15, 20, 10)
                    .enchantedItemEntry(Items.IRON_CHESTPLATE, 15, 20, 10)
                    .enchantedItemEntry(Items.IRON_LEGGINGS, 15, 20, 10)
                    .enchantedItemEntry(Items.IRON_BOOTS, 15, 20, 10)
                );
