...
public class WitchTowerStructure extends StructureConfigurator {
    ...
    protected void createLootTables(FormationsLootTableGenerator generator){
        generator.lootTable("witch_tower/arrow_trap")
            .chestParameters()
            .pool(pool ->
                pool.uniformRolls(3, 6)
                    .itemEntry(Items.ARROW, 1, 5, 1)
            );
        ...
        generator.lootTable("witch_tower/smithing")
            ...
            .pool(pool ->
                pool.uniformRolls(0, 1)
                    .enchantedItemEntry(Items.IRON_SWORD, 10, true, 3)
                    .enchantedItemEntry(Items.IRON_PICKAXE, 10, true, 3)
                    .enchantedItemEntry(Items.IRON_AXE, 10, true, 3)
                    .enchantedItemEntry(Items.IRON_SHOVEL, 10, true, 3)
                    .enchantedItemEntry(Items.IRON_HOE, 10, true, 2)
                    .enchantedItemEntry(Items.CHAINMAIL_HELMET, 10, true, 4)
                    .enchantedItemEntry(Items.CHAINMAIL_CHESTPLATE, 10, true, 4)
                    .enchantedItemEntry(Items.CHAINMAIL_LEGGINGS, 10, true, 4)
                    .enchantedItemEntry(Items.CHAINMAIL_BOOTS, 10, true, 4)
            );
        generator.lootTable("witch_tower/spawner")
            .pool(pool ->
                pool.uniformRolls(3, 4)
                    .itemEntry(Items.IRON_INGOT, 1, 4, 3)
                    .itemEntry(Items.IRON_NUGGET, 2, 12, 5)
                    .itemEntry(Items.GOLD_INGOT, 2, 5, 3)
                    .itemEntry(Items.GOLD_NUGGET, 2, 12, 5)
                    .itemEntry(Items.LAPIS_LAZULI, 1, 8, 3)
                    .itemEntry(Items.COPPER_INGOT, 2, 12, 5)
                    .itemEntry(Items.EMERALD, 1, 3, 1)
            )
            .pool(pool ->
                pool.uniformRolls(4, 5)
                    .itemEntry(Items.ROTTEN_FLESH, 1, 4, 5)
                    .itemEntry(Items.BONE, 1, 4, 3)
                    .itemEntry(Items.GLASS_BOTTLE, 1, 4, 5)
                    .itemEntry(Items.GOLDEN_APPLE)
                    .itemEntry(Items.REDSTONE, 2, 7, 2)
            );
        generator.lootTable("witch_tower/contraption_reward")
            .pool(pool ->
                pool.uniformRolls(4, 5)
                    .itemEntry(Items.EMERALD, 1, 2,2)
                    .itemEntry(Items.DIAMOND, 1)
            )
            .pool(pool ->
                pool.uniformRolls(1, 2)
                    .enchantedItemEntry(Items.IRON_SWORD, 15, 20, false, 10)
                    .enchantedItemEntry(Items.IRON_PICKAXE, 15, 20, false, 10)
                    .enchantedItemEntry(Items.IRON_AXE, 15, 20, false, 10)
                    .enchantedItemEntry(Items.IRON_SHOVEL, 15, 20, false, 10)
                    .enchantedItemEntry(Items.IRON_HOE, 15, 20, false, 10)
                    .enchantedItemEntry(Items.IRON_HELMET, 15, 20, false, 10)
                    .enchantedItemEntry(Items.IRON_CHESTPLATE, 15, 20, false, 10)
                    .enchantedItemEntry(Items.IRON_LEGGINGS, 15, 20, false, 10)
                    .enchantedItemEntry(Items.IRON_BOOTS, 15, 20, false, 10)
                );
        generator.lootTable("witch_tower/contraption_trap")
            .pool(pool ->
                pool.uniformRolls(4, 6)
                    .itemEntry(Items.ARROW, 3, 5, 1)
            );
    }
}
