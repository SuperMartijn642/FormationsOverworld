        ...
        generator.lootTable("witch_tower/smithing")
            ...
            .pool(pool ->
                pool.uniformRolls(0, 2)
                    .enchantedItemEntry(Items.IRON_SWORD, 20, true, 20)
                    .enchantedItemEntry(Items.IRON_PICKAXE, 20, true, 20)
                    .enchantedItemEntry(Items.IRON_AXE, 20, true, 20)
                    .enchantedItemEntry(Items.IRON_SHOVEL, 20, true, 20)
                    .enchantedItemEntry(Items.IRON_HOE, 20, true, 15)
                    .enchantedItemEntry(Items.IRON_HELMET, 20, true, 20)
                    .enchantedItemEntry(Items.IRON_CHESTPLATE, 20, true, 20)
                    .enchantedItemEntry(Items.IRON_LEGGINGS, 20, true, 20)
                    .enchantedItemEntry(Items.IRON_BOOTS, 20, true, 20)
                    .enchantedItemEntry(Items.DIAMOND_SWORD, 25, true, 1)
                    .enchantedItemEntry(Items.DIAMOND_PICKAXE, 25, true, 1)
                    .enchantedItemEntry(Items.DIAMOND_AXE, 25, true, 1)
                    .enchantedItemEntry(Items.DIAMOND_SHOVEL, 25, true, 1)
                    .enchantedItemEntry(Items.DIAMOND_HOE, 25, true, 1)
                    .enchantedItemEntry(Items.DIAMOND_HELMET, 25, true, 1)
                    .enchantedItemEntry(Items.DIAMOND_CHESTPLATE, 25, true, 1)
                    .enchantedItemEntry(Items.DIAMOND_LEGGINGS, 25, true, 1)
                    .enchantedItemEntry(Items.DIAMOND_BOOTS, 25, true, 1)
            );
    }
}
